...
# Módulo de GKE que usa las variables de Shared VPC para el entorno de PROD
module "gke_cluster" {
  source = "../../modules/gke_cluster"

  # --- Parámetros del Clúster ---
  name_prefix = "gke-n8n-cluster-prod" # Nombre específico para PROD
  project_id  = var.gcp_project_id
  region      = var.gcp_region
