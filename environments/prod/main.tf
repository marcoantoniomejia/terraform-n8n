# c:\Users\marmejia\Documents\Desarrollo\terraform-n8n\terraform-n8n\environments\prd\main.tf
...
module "gke_cluster" {
  ...
  name       = "gke-n8n-cluster-prd" # Nombre específico para Prod
...
# --- Discos Regionales para Producción ---
